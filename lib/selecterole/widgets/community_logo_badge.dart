...
class CommunityLogoBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color themeColor = switch (type) {
      CommunityLogoType.brother => const Color(0xFF5B7C99),
      CommunityLogoType.sister => const Color(0xFFD18E8E),
      CommunityLogoType.jumma => const Color(0xFF436E50),
    };
...
class ExactMosqueLogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Combine all white solid components
    ...
    // --- 5. CUT OUT THE 3 ARCHES (DOORWAYS) AT THE BOTTOM ---
    // Left arch
    final leftArch = Path();
    ...
    // Subtract all 3 arches from the main mosque path
    fullMosquePath = Path.combine(
