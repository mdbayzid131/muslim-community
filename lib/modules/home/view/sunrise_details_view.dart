...
class SunriseDetailsView extends StatelessWidget {
  final Color? themeColor;
  final bool? isMale;

  const SunriseDetailsView({
    super.key,
    this.themeColor,
    this.isMale,
  });
  ...
  Widget build(BuildContext context) {
    ...
    final activeThemeColor = themeColor ?? AppColors.getRoleColor(role);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildHadithCard(activeThemeColor),
            SizedBox(height: 20.h),
          ],
        ),
      ),
  ...
  Widget _buildHadithCard(Color themeColor) {
    return Container(
      width: double.infinity,
      decoration: BoxDecoration(
