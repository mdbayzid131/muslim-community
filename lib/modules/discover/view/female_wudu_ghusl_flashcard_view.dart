...
class FemaleWuduGhuslFlashcardView extends StatefulWidget {
  final String title;

  const FemaleWuduGhuslFlashcardView({super.key, required this.title});

  @override
  State<FemaleWuduGhuslFlashcardView> createState() => _FemaleWuduGhuslFlashcardViewState();
}

class _FemaleWuduGhuslFlashcardViewState extends State<FemaleWuduGhuslFlashcardView> {
