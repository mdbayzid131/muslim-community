...
class MaleWuduGhuslFlashcardView extends StatefulWidget {
  final String title;

  const MaleWuduGhuslFlashcardView({super.key, required this.title});

  @override
  State<MaleWuduGhuslFlashcardView> createState() => _MaleWuduGhuslFlashcardViewState();
}

class _MaleWuduGhuslFlashcardViewState extends State<MaleWuduGhuslFlashcardView> {
