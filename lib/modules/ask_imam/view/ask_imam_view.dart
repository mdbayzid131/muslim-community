...
class AskImamView extends StatefulWidget {
  const AskImamView({super.key});

  @override
  State<AskImamView> createState() => _AskImamViewState();
}

class _AskImamViewState extends State<AskImamView> {
  bool isAskTab = true;
  late final AskImamController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.find<AskImamController>();
  }
          ...
          child: Column(
            children: [
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: isAskTab ? roleColor : Colors.transparent,
              ...
              AnimatedSwitcher(
                ...
                child: isAskTab
                    ? _buildAskForm(roleColor, roleLabel)
                    : _buildAnsweredList(roleColor, roleLabel),
              ),
  ...
  Widget _buildAskForm(Color roleColor, String roleLabel) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Text(
              'Your question will be answered by a qualified $roleLabel. Please be respectful and patient.',
  ...
  Widget _buildAnsweredList(Color roleColor, String roleLabel) {
    return Obx(() {
