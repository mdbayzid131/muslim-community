...
import 'package:muslim_community/female_role/messages/ui/femalechatui.dart';
...
class MessageTile extends StatelessWidget {
  ...
  Widget _buildAvatar() {
    if (message.imageUrl != null && message.imageUrl!.isNotEmpty) {
      ...
      return Container(
        decoration: BoxDecoration(
          color: const Color(0xFFF5EFE6), // Slightly darker cream for contrast
          borderRadius: BorderRadius.circular(15.r),
        ...
        child: Text(
          ...
          style: GoogleFonts.playfairDisplay(
            fontSize: 24.sp,
            color: _roleColor, // Female color text for initials
          ),
        ),
      );
    }
