...
import 'package:muslim_community/female_role/messages/controller/messages_controller.dart';
import 'package:muslim_community/female_role/messages/ui/widgets/message_tile.dart';

class FemaleMessagesUI extends StatelessWidget {
  const FemaleMessagesUI({super.key});

  @override
  Widget build(BuildContext context) {
    final FemaleMessagesController controller = Get.put(
      FemaleMessagesController(),
    );
  ...
  Widget _buildSearchBar(FemaleMessagesController controller) {
    return Container(
      height: 45.h,
