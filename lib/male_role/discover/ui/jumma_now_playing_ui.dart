...
class MaleJummaNowPlayingUI extends StatefulWidget {
  const MaleJummaNowPlayingUI({super.key});

  @override
  State<MaleJummaNowPlayingUI> createState() => _MaleJummaNowPlayingUIState();
}

class _MaleJummaNowPlayingUIState extends State<MaleJummaNowPlayingUI> {
  ...
  void initState() {
    ...
    try {
      ...
      debugPrint(
        "MaleJummaNowPlayingUI: Get.arguments received: $args (Type: ${args?.runtimeType})",
      );
      ...
      if (args is KhutbahModel) {
        ...
        debugPrint("Warning: Get.arguments is null in MaleJummaNowPlayingUI");
      }
    } catch (e, stack) {
      debugPrint(
        "Exception inside MaleJummaNowPlayingUI initState: $e\n$stack",
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    const Color themeColor = AppColors.maleColor;
